...
Future<Map<String, dynamic>?> showCreateGroupPopup(
    BuildContext context, String categoryAlias) {
  return showDialog<Map<String, dynamic>>(
    context: context,
    barrierDismissible: false,
    builder: (context) => CreateGroupPopup(categoryAlias: categoryAlias),
  );
}
...
class CreateGroupPopup extends StatefulWidget {
  ...
  const CreateGroupPopup({Key? key, required this.categoryAlias})
      : super(key: key);
    ...
    return Dialog(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text('Create New Group', style: AppTheme.popupTitleStyle),
            const SizedBox(height: 4),
            Text(
              'Category: ${widget.categoryAlias}',
              style: AppTheme.mediaItemSubtitleStyle,
            ),
            const SizedBox(height: 16),
            _buildTextField(_aliasController, 'Alias (unique identifier)',
                hint: 'e.g. kargin_haghordum_7'),
            const SizedBox(height: 10),
            _buildTextField(_nameController, 'Name',
                hint: 'e.g. \u053F\u0561\u0580\u0563\u056B\u0576 \u0540\u0561\u0572\u0578\u0580\u0564\u0578\u0582\u0574 7'),
            const SizedBox(height: 10),
            ...
            if (_errorMessage != null) ...[
              ...
              Text(_errorMessage!,
                  style: const TextStyle(color: AppTheme.accentMagenta, fontSize: 13)),
            ],
            const SizedBox(height: 16),
            Row(
        ...
        Row(
          children: [
            ElevatedButton.icon(
              ...
              label: Text(_isUploadingThumbnail ? 'Uploading...' : 'Choose JPG'),
              style: ElevatedButton.styleFrom(
            ...
            if (_iconUrlController.text.isNotEmpty && !_isUploadingThumbnail)
              ClipRRect(
            ...
            if (_thumbnailBytes != null && _iconUrlController.text.isEmpty)
              ClipRRect(
                borderRadius: BorderRadius.circular(6),
                child: Image.memory(
                  _thumbnailBytes!,
